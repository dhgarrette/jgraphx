...
do
  ...
  echo $version
  dir=public_html/maven-repository/releases/com/mxgraph/${projectname}/$version
  echo $dir
  ssh k mkdir -p $dir
  echo 'scp' $f k:$dir
  scp $f k:$dir
...
scp -r target/scala-2.11/api k:public_html/maven-repository/releases/com/mxgraph/${projectname}/$version
